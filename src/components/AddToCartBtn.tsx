      ...
      {existingProduct ? (
        <div className="flex self-start items-center gap-5 mt-3">
          <button
            ...
            disabled={!existingProduct?.quantity || existingProduct.quantity <= 1}
        ...
        <button
          ...
          className={twMerge(
            "mt-2 border border-primaryColor w-full capitalize hover:bg-primaryColor hover:text-white duration-300 text-lg",
            className
          )}
        >
          Add to Cart
