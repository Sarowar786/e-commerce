      ...
      <div className="flex flex-1 ml-4 flex-col justify-between">
        <div className=" relative pr-9 sm:grid sm:grid-cols-1 grid-cols-7 ">
          ...
          <div>
            ...
            <p className="flex items-center gap-3">You are saving <PriceFormat amount={product?.price * (product?.discountPercentage / 100 ) * product?.quantity!} className="text-green-600"/> upon purchase </p>
          </div>
      </div>
    </div>
  );
