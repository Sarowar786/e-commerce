...
export default function MainLoader() {
  return (
    <div>
      ...
      <span className="w-14 h-14 inline-flex border-8 border-primaryColor rounded-full relative">
        <span className="w-14 h-14 border-8 border-r-skyColor border-b-primaryColor border-t-borderColor border-l-borderColor rounded-full absolute -top-2 -left-2 animate-spin" />
      </span>
